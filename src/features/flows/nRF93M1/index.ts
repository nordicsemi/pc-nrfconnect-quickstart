...
import {
    ...
    onCancel,
    program93ModemFirmware,
} from './93ModemFirmwareUpgrade';
...
const programConfig = [
            ...
            actions: [
                ...
                },
                {
                    ...
                    displayInfo: {
                        title: 'nRF93M1',
                        link: {
                            label: 'Modem Firmware v1.5.0',
                            href: 'https://www.nordicsemi.com/Products/Development-hardware/nRF93M1-DK',
                        },
                    },
                    run: checkModemFirmwareVersion('1.5.0', 1, 'LINE'),
                    onConfirm: program93ModemFirmware(
                        'mfw_nrf93m1_update_from_1.4.1_to_1.5.0.bin',
                        1,
                    ),
                    onCancel,
                },
    ...
    //     type: 'action-list',
    //     description:
    //         'Run the Serial Modem Host application on the nRF54L15. The host establishes a PPP link over CMUX to the nRF93M1 and terminates DTLS and CoAP at nRF Cloud for telemetry, location, and FOTA.',
    //     documentation: {
    ...
    //                 firmware: {
    //                     coreLabel: 'nRF54',
    //                     file: 'nrf93m1dk_asset_tracker.hex',
    //                     link: {
    //                         label: 'Serial Modem Host application',
    //                         href: 'https://github.com/nrfconnect/ncs-serial-modem-host-applications/tree/main/applications/93m1_ppp',
    //                     },
    ...
    //                     },
    //                 },
    //                 run: checkModemFirmwareVersion('1.5.0', 0, 'SHELL'),
    //                 onConfirm: program93ModemFirmware('mfw_nrf93m1_update_from_1.4.1_to_1.5.0.bin', 0),
    //                 onCancel,
    //             },
    //         ],
    //     },
