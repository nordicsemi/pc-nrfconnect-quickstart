...
const programConfig = [
    {
        ...
        programmingOptions: {
            firmwareList: [
                {
                    core: 'Application',
                    file: 'nrf54lc10dk_hello_world.hex',
                    link: {
                        label: 'Hello World',
                        href: 'https://docs.nordicsemi.com/bundle/ncs-latest/page/zephyr/samples/hello_world/README.html',
                    },
    ...
    },
    {
        ...
        programmingOptions: {
            firmwareList: [
                {
                    core: 'Application',
                    file: 'nrf54lc10dk_power_profiling.hex',
                    link: {
                        label: 'Peripheral Power Profiling',
                        href: 'https://docs.nordicsemi.com/bundle/ncs-latest/page/nrf/samples/bluetooth/peripheral_power_profiling/README.html',
                    },
    ...
    },
    {
        ...
        programmingOptions: {
            firmwareList: [
                {
                    core: 'Application',
                    file: 'nrf54lc10dk_peripheral_uart.hex',
                    link: {
