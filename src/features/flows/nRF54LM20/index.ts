...
const infoConfig = {
    ...
    markdownContent:
        '![nRF54LM20 DK](54LM20DK.png)  \n&nbsp;  \nThe nRF54LM20 DK enables development with nRF54LM20A and nRF54LM20B SoCs.  \n&nbsp;  \nnRF54LM20A and nRF54LM20B are part of the nRF54L Series. All wireless System-on-Chip (SoC) options in the series integrate an ultra-low-power, multiprotocol 2.4 GHz radio and MCU functionality featuring a 128 MHz Arm Cortex-M33 processor. Each of these SoCs features an extended peripheral set, high-speed USB, increased memory size with 2036 KB NVM and 512 KB RAM, and up to 66 GPIOs.  \n&nbsp;  \nThe nRF54LM20B also adds an integrated [Axon NPU](https://www.nordicsemi.com/Products/Technologies/Edge-AI) (Neural Processing Unit). The NPU increases the speed and efficiency of on-device AI inference by up to 15x compared to running the same task on the CPU.  \n&nbsp;  \n![nRF54LM20 DK Technologies](54SeriesTech.png)  \nThe multiprotocol 2.4 GHz radio of nRF54LM20A and nRF54LM20B supports Bluetooth LE with optional features, including Channel Sounding introduced in Bluetooth 6.0, 802.15.4-2020 for standards such as Thread, Matter, and Zigbee, and a proprietary 2.4 GHz mode supporting up to 4 Mbps for higher throughput.  \n&nbsp;  \nFor the datasheet and more information, see the web pages for the [nRF54LM20A SoC](https://www.nordicsemi.com/Products/nRF54LM20A), the [nRF54LM20B SoC](https://www.nordicsemi.com/Products/nRF54LM20B), and the [nRF54LM20 DK](https://www.nordicsemi.com/Products/Development-hardware/nRF54LM20-DK). ',
};
